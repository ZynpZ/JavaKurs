...
public class DAvciKuslar extends BKuslar{
    ...
    String tur="Avcı Kusu";
    String isim="Avcı kusu İsim belirtilmedi";
    String yasamYeri="Avcı kuslar kumeste yasar";
    String enSevdikleriYiyecek="Yaban tavsanı";
    ...
    void pence () {
        System.out.println("Avcı kusların penceleri vardır");
    }
    void gaga (){
    ...
    public static void main(String[] args) {
        ...
        avk1.kanat(); // B Kuslar kanatlidir // data türü ve cons aynı olduğu için overridding olmaz. bulduğun yerdekini alırsın
